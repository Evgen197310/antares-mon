...
#
#  ☐ Подключается по SSH к каждому заданному MikroTik
#  ☐ Берёт /system identity
#  ☐ Выдёргивает ВСЕ активные IPv4 + интерфейсы + флаги
#  ☐ Пишет:
#        /etc/rsyslog.d/mikrotik_map.txt   (IP|IDENTITY)
#        /var/lib/mikrotik/full_map.csv    (identity,ip,mask,interface,flags)
#
#  Автор: ChatGPT (o3) • 2025-06-14
# -----------------------------------------------------------------------------
